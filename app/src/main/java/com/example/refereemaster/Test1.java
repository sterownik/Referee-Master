...
public class Test1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        new AlertDialog.Builder(Test1.this)
                .setTitle("Informacja")
                .setMessage("Witam w teście wiedzy o zasadach piłki ręcznej")
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    //exp = 10*pkt+experience;
                        ...
                        if(czyzmienilo) {
                            UserName userName = new UserName(dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getName(), punktypierwszagrat, experience, dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getPunktydrugagra(), punktytrzeciagra, punktyczwartagra, liczbabonusow, data, le + 1, dobre, dt);
