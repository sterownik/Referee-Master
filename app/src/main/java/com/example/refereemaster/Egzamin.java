...
public class Egzamin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        new AlertDialog.Builder(Egzamin.this)
                .setTitle("Informacja")
                .setMessage("Witam na egzaminie!\nOdpowiedz na 40 pytań, aby zdać potrzebujesz 30 dobrych odpowiedzi\nNa każde pytanie masz 90 sekund.\nPowodzenia!")
    ...
    public void Play() throws IOException
    {
        ...
        iloscpytantxt.setText(Integer.toString(40-ilosc)+"");
             ...
             mCountDownTimer.cancel();
               databaseReference.addValueEventListener(new ValueEventListener() {
                   ...
                   public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                      ...
                      float procent;
                       if(punktyczwartagra<dobre&&czyzmienilo)
                       {
                           UserName userName = new UserName(dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getName(),punktypierwszagrat,experience+(10*dobre),dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getPunktydrugagra(),punktytrzeciagra,dobre,liczbabonusow+(dobre),data,le,pt,dt);
                           databaseReference.child(user.getUid()).setValue(userName);
                           czyzmienilo=false;
                       }
                       else if(punktyczwartagra>=dobre&&czyzmienilo)
                       {
                       ...
                       if(dobre>=30)
                       {
                           procent=dobre/40*100;
                            drawable = R.drawable.like;

                            text = "Zdałeś egzamin zdobywając " + dobre*100/40+"%";

                       }
                       else
                       {
                           procent=dobre/40*100;
                            drawable = R.drawable.dislike;
                           text = "Nie zdałeś egzaminu zdobywając " + dobre*100/40+"%";
                       }
                       new AlertDialog.Builder(Egzamin.this)
                               .setTitle("Informacja")
                               .setMessage(text).setIcon(drawable)
