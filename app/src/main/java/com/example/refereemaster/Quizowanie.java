...
odliczanie2=4;
        ...
        new AlertDialog.Builder(Quizowanie.this)
                .setTitle("Informacja")
                .setMessage("Witam na treningu do egzaminu!\nNa każde pytanie masz 90 sekund.\nPowodzenia!")
   ...
   //     txt1.addRule(RelativeLayout.CENTER_HORIZONTAL);
    ...
    public boolean sprawdzanie(final CheckBox[] checkBoxes, final Button button, final String[] str, final int liczba, boolean czas)
    {
                    ...
                    final FirebaseUser user = firebaseAuth.getCurrentUser();
                            ...
                            databaseReference.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if(punktytrzeciagra<dobre&&czyzmienilo)
                                    {
                                        UserName userName = new UserName(dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getName(),punktypierwszagrat,experience+(10*dobre),dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getPunktydrugagra(),dobre,punktyczwartagra,liczbabonusow+dobre,data,le,pt,dt);
                                        databaseReference.child(user.getUid()).setValue(userName);
                                        czyzmienilo=false;
                                    }
                                    else if(punktytrzeciagra>=dobre&&czyzmienilo)
                                    {
                                        UserName userName = new UserName(dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getName(),punktypierwszagrat,experience+(10*dobre),dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getPunktydrugagra(),punktytrzeciagra,punktyczwartagra,liczbabonusow+dobre,data,le,pt,dt);
                                        databaseReference.child(user.getUid()).setValue(userName);
                                        czyzmienilo=false;
                                    }
                                    czyzmienilo=false;
                            ...
                            new AlertDialog.Builder(Quizowanie.this)
                                    .setTitle("Informacja")
                                    .setMessage("Przegrałeś zdobywając "+dobre+" punktów")
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    databaseReference.addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            if(liczbabonusow>=10&&czyzmienilo2&&czyzmienilo)
                                            {
                                            ...
                                            else if(liczbabonusow<10&&czyzmienilo2&&punktytrzeciagra<dobre) {

                                                Toast.makeText(getApplicationContext(), "Nie masz wystarczająco dużo złotych gwizdków", Toast.LENGTH_LONG).show();
                                                UserName userName = new UserName(dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getName(),punktypierwszagrat,experience,punktydrugragra,dobre,punktyczwartagra,liczbabonusow+dobre,data,le,pt,dt);
                                                databaseReference.child(user.getUid()).setValue(userName);
                                                czyzmienilo2=false;
                                                mCountDownTimer.cancel();
                                                startActivity(new Intent(getApplicationContext(), Games.class));
                                                ...
                                                Toast.makeText(getApplicationContext(), "Nie masz wystarczająco dużo złotych gwizdków", Toast.LENGTH_LONG).show();
                                                UserName userName = new UserName(dataSnapshot.child(user.getUid()).getValue(UserInformation.class).getName(),punktypierwszagrat,experience,punktydrugragra,punktytrzeciagra,punktyczwartagra,liczbabonusow+dobre,data,le,pt,dt);
                                                databaseReference.child(user.getUid()).setValue(userName);
                                                czyzmienilo2=false;
                                                mCountDownTimer.cancel();
                                                startActivity(new Intent(getApplicationContext(), Games.class));
